...
# perl /data2/projects/gbsflowering/perltoctoc/QuatarPillar-bgl-ec-debug-posi.pl -vcf /scratch/test/sort-all-merge-LG1-19.GATKSV.SNP.vcf -conf /data2/projects/gbsflowering/perltoctoc/saga_EC.config -ref /data2/projects/gbsflowering/Bank/sort-LG1-19.fasta -trait /data2/projects/gbsflowering/perltoctoc/flo_206_dat_trait.txt -gff /data2/projects/gbsflowering/Bank/ref_DPV01_scaffolds.gff3"

#qsub -b Y -V -cwd -m bea -M emira.cherif@ird.fr -pe ompi 4 -N sagzouil -q r900.q@node21 "perl /data2/projects/gbsflowering/perltoctoc/QuatarPillar-bgl-ec-debug-posi.pl -vcf /scratch/test/sort-all-merge-LG1-19.GATKSV.SNP.vcf -conf /data2/projects/gbsflowering/perltoctoc/saga_EC.config -ref /data2/projects/gbsflowering/Bank/sort-LG1-19.fasta -trait /data2/projects/gbsflowering/perltoctoc/flo_206_dat_trait.txt -gff /data2/projects/gbsflowering/Bank/ref_DPV01_scaffolds.gff3"
...
{
   print STDERR " #### $0 Error: The vcf file, config file, trait file, gff file and/or reference files must be provided \n\n";
   exit;
}
...
{     
      ...
      else
      {
         ...
         if ($percent>=$geno_percent) # The VCF file lines are printed if the chosen $geno_percent condition is reached  
         {
            print "#### $percent #### \n\n";
            print VCFOUT $line;
         }
...
if ($gapit eq "COV")
{
   ...
   print "#### $0 Info: GAPIT Using ECMLM by Li and et. al. (BMC Biology, 2014) with provided"." $gapit"."ARIATE file has been sucessfully done \n\n";
